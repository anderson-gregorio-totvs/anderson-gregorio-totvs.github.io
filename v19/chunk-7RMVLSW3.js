...
`),t()(),i(69,"h4",9),e(70,"Propriedades"),t(),i(71,"table",10)(72,"tr",11)(73,"th",12),e(74,"Nome"),t(),i(75,"th",12),e(76,"Tipo"),t(),i(77,"th",12),e(78,"Padr\xE3o"),t(),i(79,"th",12),e(80,"Descri\xE7\xE3o"),t()(),i(81,"tr",13)(82,"td",14)(83,"div",15)(84,"span",16),e(85," p-show-detail"),l(86,"br"),t()()(),i(87,"td",17)(88,"code",18),e(89,"(item) => boolean"),t()(),i(90,"td",19),e(91,"-"),t(),i(92,"td",20)(93,"em")(94,"strong"),e(95,"(opcional)"),t()(),i(96,"p"),e(97,"Fun\xE7\xE3o que deve retornar um valor do tipo "),i(98,"code"),e(99,"boolean"),t(),e(100,`, que ser\xE1 utilizado como a valida\xE7\xE3o para que o detalhe de item
da lista inicie aberto ou fechado.`),t()()()()())},dependencies:[S],encapsulation:2})}return o})();var P=(()=>{class o{route;router;sub;hidePoWebSample=!0;samplesLength=0;activeTab="doc";actions=[{label:"Documenta\xE7\xE3o",action:this.goBack.bind(this),icon:"an an-file-text"},{label:"Colabore",action:this.improveDocs.bind(this)}];constructor(a,n){this.route=a,this.router=n}goBack(){this.router.navigate(["documentation"])}improveDocs(){this.router.navigate(["guides/development-flow"])}ngOnInit(){this.sub=this.route.queryParams.subscribe(a=>{let n=a.view;this.activeTab=n||"doc",this.hidePoWebSample=this.samplesLength===0})}ngOnDestroy(){this.sub.unsubscribe()}static \u0275fac=function(n){return new(n||o)(u(v),u(x))};static \u0275cmp=m({type:o,selectors:[["ng-component"]],standalone:!1,decls:5,vars:4,consts:[["p-title"," List View Detail Template",3,"p-actions"],["p-size","1"],["p-label","Documenta\xE7\xE3o",3,"p-active"],["p-label","Exemplos",3,"p-hide","p-active"]],template:function(n,r){n&1&&(i(0,"po-page-default",0)(1,"po-tabs",1)(2,"po-tab",2),l(3,"sample-po-list-view-detail-template-doc"),t(),l(4,"po-tab",3),t()()),n&2&&(s("p-actions",r.actions),c(2),s("p-active",r.activeTab.includes("doc")),c(2),s("p-hide",r.hidePoWebSample)("p-active",r.activeTab.includes("web")))},dependencies:[b,h,w,g],encapsulation:2})}return o})();var y=[{path:"",component:P}],C=(()=>{class o{static \u0275fac=function(n){return new(n||o)};static \u0275mod=d({type:o});static \u0275inj=p({imports:[E.forChild(y),E]})}return o})();var W=(()=>{class o{static \u0275fac=function(n){return new(n||o)};static \u0275mod=d({type:o});static \u0275inj=p({imports:[D,C]})}return o})();export{W as DocPoListViewDetailTemplateModule};
