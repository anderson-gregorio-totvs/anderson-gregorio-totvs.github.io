...
para seus valores iniciais.`),t()()()()())},dependencies:[k],encapsulation:2})}return i})();var Ee=(()=>{class i{route;router;sub;hidePoWebSample=!0;samplesLength=3;activeTab="doc";actions=[{label:"Documenta\xE7\xE3o",action:this.goBack.bind(this),icon:"an an-file-text"},{label:"Colabore",action:this.improveDocs.bind(this)}];constructor(l,a){this.route=l,this.router=a}goBack(){this.router.navigate(["documentation"])}improveDocs(){this.router.navigate(["guides/development-flow"])}ngOnInit(){this.sub=this.route.queryParams.subscribe(l=>{let a=l.view;this.activeTab=a||"doc",this.hidePoWebSample=this.samplesLength===0})}ngOnDestroy(){this.sub.unsubscribe()}static \u0275fac=function(a){return new(a||i)(y(J),y(Z))};static \u0275cmp=g({type:i,selectors:[["ng-component"]],standalone:!1,decls:8,vars:4,consts:[["p-title"," Button",3,"p-actions"],["p-size","1"],["p-label","Documenta\xE7\xE3o",3,"p-active"],["p-label","Exemplos",3,"p-hide","p-active"]],template:function(a,o){a&1&&(n(0,"po-page-default",0)(1,"po-tabs",1)(2,"po-tab",2),r(3,"sample-po-button-doc"),t(),n(4,"po-tab",3),r(5,"sample-po-button-basic-view")(6,"sample-po-button-labs-view")(7,"sample-po-button-social-network-view"),t()()()),a&2&&(s("p-actions",o.actions),d(2),s("p-active",o.activeTab.includes("doc")),d(2),s("p-hide",o.hidePoWebSample)("p-active",o.activeTab.includes("web")))},dependencies:[le,v,C,se,ce,be,ge],encapsulation:2})}return i})();var De=[{path:"",component:Ee}],Se=(()=>{class i{static \u0275fac=function(a){return new(a||i)};static \u0275mod=L({type:i});static \u0275inj=I({imports:[N.forChild(De),N]})}return i})();var it=(()=>{class i{static \u0275fac=function(a){return new(a||i)};static \u0275mod=L({type:i});static \u0275inj=I({imports:[pe,Se]})}return i})();export{it as DocPoButtonModule};
