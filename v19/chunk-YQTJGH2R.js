import{$ as g,$a as x,$c as T,Cd as F,Ga as n,Ia as H,Jb as y,Ka as q,La as P,Lb as L,Ma as S,Ob as D,Od as N,Pa as I,T as s,U as m,Wb as M,Xd as v,Yb as k,Yd as C,Zb as E,_ as u,ae as X,ha as c,ka as R,md as _,na as e,oa as t,oc as O,pa as p,pb as w,re as B,se as W,ua as f,y as b}from"./chunk-23IW53AA.js";var z=(()=>{class o{http;httpRequestInterceptor;countPendingRequestHeaderParam=!1;screenLockHeaderParam=!1;pendingRequests=0;url="";subscription;apiSubscription;constructor(a,i){this.http=a,this.httpRequestInterceptor=i}ngOnDestroy(){this.subscription.unsubscribe(),this.apiSubscription&&this.apiSubscription.unsubscribe()}ngOnInit(){this.subscription=this.httpRequestInterceptor.getCountPendingRequests().subscribe(a=>{this.pendingRequests=a})}getRequest(){let a={"X-PO-No-Count-Pending-Requests":this.countPendingRequestHeaderParam.toString(),"X-PO-Screen-Lock":this.screenLockHeaderParam.toString()};this.apiSubscription=this.http.get(this.url,{headers:a}).subscribe(()=>{})}static \u0275fac=function(i){return new(i||o)(m(w),m(X))};static \u0275cmp=u({type:o,selectors:[["sample-po-http-request-interceptor-labs"]],standalone:!1,decls:9,vars:5,consts:[[1,"po-row"],["p-label","Pending Requests",1,"po-lg-12",3,"p-value"],["name","url","p-help","https://po-sample-api.onrender.com/v1/people","p-label","URL","p-required","",1,"po-lg-6",3,"ngModelChange","ngModel"],["name","countPendingRequestHeaderParam","p-help","Enable/disable the sent param in header of request","p-label","X-PO-No-Count-Pending-Requests","p-label-off","Disable","p-label-on","Enable","ngDefaultControl","",1,"po-lg-6",3,"ngModelChange","ngModel"],["name","screenLockHeaderParam","p-help","Enable/disable the sent param in header of request","p-label","X-PO-Screen-Lock","p-label-off","Disable","p-label-on","Enable","ngDefaultControl","",1,"po-lg-6",3,"ngModelChange","ngModel"],["p-label","Get request",1,"po-md-4",3,"p-click","p-disabled"]],template:function(i,r){i&1&&(e(0,"div",0),p(1,"po-info",1),t(),e(2,"div",0)(3,"po-input",2),S("ngModelChange",function(l){return P(r.url,l)||(r.url=l),l}),t()(),e(4,"div",0)(5,"po-switch",3),S("ngModelChange",function(l){return P(r.countPendingRequestHeaderParam,l)||(r.countPendingRequestHeaderParam=l),l}),t(),e(6,"po-switch",4),S("ngModelChange",function(l){return P(r.screenLockHeaderParam,l)||(r.screenLockHeaderParam=l),l}),t()(),e(7,"div",0)(8,"po-button",5),f("p-click",function(){return r.getRequest()}),t()()),i&2&&(s(),c("p-value",r.pendingRequests),s(2),q("ngModel",r.url),s(2),q("ngModel",r.countPendingRequestHeaderParam),s(),q("ngModel",r.screenLockHeaderParam),s(2),c("p-disabled",!r.url))},dependencies:[y,L,D,O,_,T,F],encapsulation:2})}return o})();var K=o=>({"docs-sample-code-tabs":o}),V=(()=>{class o{hideSampleCodeTabs=!0;sampleCodeButtonLabel="Talk is cheap, show me the code!";sampleCodeButtonIcon="ph ph-plus";toggleSampleCodeTabs(){this.hideSampleCodeTabs=!this.hideSampleCodeTabs,this.sampleCodeButtonLabel=this.hideSampleCodeTabs?"Talk is cheap, show me the code!":"Okay, hide the code",this.sampleCodeButtonIcon=this.hideSampleCodeTabs?"ph ph-plus":"ph ph-minus"}static \u0275fac=function(i){return new(i||o)};static \u0275cmp=u({type:o,selectors:[["sample-po-http-request-interceptor-labs-view"]],standalone:!1,decls:24,vars:6,consts:[[1,"sample-blockquote"],[1,"sample-title","po-font-text-large-bold"],[1,"show-me-the-code",3,"click"],[3,"ngClass"],["p-size","2"],["p-label","HTML","p-active",""],[1,"doc-label-path"],["appCodeHighlight","",1,"html"],["p-label","TS"],["appCodeHighlight","",1,"typescript"],[1,"docs-sample-container"]],template:function(i,r){i&1&&(p(0,"br"),e(1,"blockquote",0)(2,"label",1),n(3,"PO Http Request Interceptor Labs"),t(),e(4,"a",2),f("click",function(){return r.toggleSampleCodeTabs()}),p(5,"span"),n(6),t()(),e(7,"div",3)(8,"po-tabs",4)(9,"po-tab",5)(10,"div")(11,"label",6),n(12,"sample-po-http-request-interceptor-labs.component.html"),t(),e(13,"pre",7),n(14,`<div class="po-row">
...
`),t()()()()(),e(21,"div",10),p(22,"sample-po-http-request-interceptor-labs"),t(),p(23,"hr")),i&2&&(s(5),R("po-icon "+r.sampleCodeButtonIcon),s(),H(" ",r.sampleCodeButtonLabel,""),s(),c("ngClass",I(4,K,r.hideSampleCodeTabs)))},dependencies:[x,B,v,C,z],encapsulation:2})}return o})();var A=(()=>{class o{static \u0275fac=function(i){return new(i||o)};static \u0275cmp=u({type:o,selectors:[["sample-po-http-request-interceptor-doc"]],standalone:!1,decls:67,vars:0,consts:[[1,"docs-api"],[1,"docs-api-module-import"],[1,"docs-api-class-description"],[1,"docs-api-h3"],[1,"docs-api-class-name"],[1,"doc-code"]],template:function(i,r){i&1&&(e(0,"div",0)(1,"p",1)(2,"code"),n(3,"import { PoHttpRequestModule } from '@po-ui/ng-components';"),t()(),p(4,"div",2),e(5,"h3",3),n(6,"Services"),t(),e(7,"h4",4)(8,"code",5),n(9,"PoHttpRequestInterceptorService"),t()(),e(10,"div",2)(11,"p"),n(12,"O servi\xE7o PO Http Request Interceptor realiza a contabiliza\xE7\xE3o de requisi\xE7\xF5es pendentes na aplica\xE7\xE3o."),t(),e(13,"p"),n(14,`Existe a possibilidade de n\xE3o efetuar a contabiliza\xE7\xE3o das requisi\xE7\xF5es pendentes, utilizando o par\xE2metro
...
}`),t()()()())},encapsulation:2})}return o})();var U=(()=>{class o{route;router;sub;hidePoWebSample=!0;samplesLength=1;activeTab="doc";actions=[{label:"Documenta\xE7\xE3o",action:this.goBack.bind(this),icon:"ph ph-file-text"},{label:"Colabore",action:this.improveDocs.bind(this)}];constructor(a,i){this.route=a,this.router=i}goBack(){this.router.navigate(["documentation"])}improveDocs(){this.router.navigate(["guides/development-flow"])}ngOnInit(){this.sub=this.route.queryParams.subscribe(a=>{let i=a.view;this.activeTab=i||"doc",this.hidePoWebSample=this.samplesLength===0})}ngOnDestroy(){this.sub.unsubscribe()}static \u0275fac=function(i){return new(i||o)(m(M),m(k))};static \u0275cmp=u({type:o,selectors:[["ng-component"]],standalone:!1,decls:6,vars:4,consts:[["p-title"," Http Request Interceptor",3,"p-actions"],["p-size","1"],["p-label","Documenta\xE7\xE3o",3,"p-active"],["p-label","Exemplos",3,"p-hide","p-active"]],template:function(i,r){i&1&&(e(0,"po-page-default",0)(1,"po-tabs",1)(2,"po-tab",2),p(3,"sample-po-http-request-interceptor-doc"),t(),e(4,"po-tab",3),p(5,"sample-po-http-request-interceptor-labs-view"),t()()()),i&2&&(c("p-actions",r.actions),s(2),c("p-active",r.activeTab.includes("doc")),s(2),c("p-hide",r.hidePoWebSample)("p-active",r.activeTab.includes("web")))},dependencies:[N,v,C,V,A],encapsulation:2})}return o})();var Z=[{path:"",component:U}],G=(()=>{class o{static \u0275fac=function(i){return new(i||o)};static \u0275mod=g({type:o});static \u0275inj=b({imports:[E.forChild(Z),E]})}return o})();var qe=(()=>{class o{static \u0275fac=function(i){return new(i||o)};static \u0275mod=g({type:o});static \u0275inj=b({imports:[W,G]})}return o})();export{qe as DocPoHttpRequestInterceptorModule};
