...
Executada ao disparar o output `),n(927,"code"),e(928,"change"),t(),e(929," ou "),n(930,"code"),e(931,"change-model"),t(),e(932,", dependendo do valor da propriedade "),n(933,"code"),e(934,"triggerMode"),t(),e(935,"."),t()()(),n(936,"tr",16)(937,"td",17)(938,"div",18)(939,"span",19),e(940," triggerMode"),o(941,"br"),t()()(),n(942,"td",20)(943,"code",36),e(944,"'change' "),t(),n(945,"code",37),e(946," 'changeModel'"),t()(),n(947,"td",23)(948,"em")(949,"strong"),e(950,"(opcional)"),t()(),n(951,"p"),e(952,"Controla se o m\xE9todo ser\xE1 executado no disparo do output "),n(953,"code"),e(954,"change"),t(),e(955," ou "),n(956,"code"),e(957,"change-model"),t(),e(958,"."),t()()()()())},dependencies:[y],encapsulation:2})}return a})();var de=(()=>{class a{route;router;sub;hidePoWebSample=!0;samplesLength=3;activeTab="doc";actions=[{label:"Documenta\xE7\xE3o",action:this.goBack.bind(this),icon:"ph ph-file-text"},{label:"Colabore",action:this.improveDocs.bind(this)}];constructor(m,l){this.route=m,this.router=l}goBack(){this.router.navigate(["documentation"])}improveDocs(){this.router.navigate(["guides/development-flow"])}ngOnInit(){this.sub=this.route.queryParams.subscribe(m=>{let l=m.view;this.activeTab=l||"doc",this.hidePoWebSample=this.samplesLength===0})}ngOnDestroy(){this.sub.unsubscribe()}static \u0275fac=function(l){return new(l||a)(T(G),T(U))};static \u0275cmp=u({type:a,selectors:[["ng-component"]],standalone:!1,decls:8,vars:4,consts:[["p-title"," Login",3,"p-actions"],["p-size","1"],["p-label","Documenta\xE7\xE3o",3,"p-active"],["p-label","Exemplos",3,"p-hide","p-active"]],template:function(l,i){l&1&&(n(0,"po-page-default",0)(1,"po-tabs",1)(2,"po-tab",2),o(3,"sample-po-login-doc"),t(),n(4,"po-tab",3),o(5,"sample-po-login-basic-view")(6,"sample-po-login-labs-view")(7,"sample-po-login-confirm-view"),t()()()),l&2&&(c("p-actions",i.actions),p(2),c("p-active",i.activeTab.includes("doc")),p(2),c("p-hide",i.hidePoWebSample)("p-active",i.activeTab.includes("web")))},dependencies:[ee,v,C,oe,le,pe,me],encapsulation:2})}return a})();var ye=[{path:"",component:de}],se=(()=>{class a{static \u0275fac=function(l){return new(l||a)};static \u0275mod=D({type:a});static \u0275inj=k({imports:[z.forChild(ye),z]})}return a})();var Ze=(()=>{class a{static \u0275fac=function(l){return new(l||a)};static \u0275mod=D({type:a});static \u0275inj=k({imports:[te,se]})}return a})();export{Ze as DocPoLoginModule};
