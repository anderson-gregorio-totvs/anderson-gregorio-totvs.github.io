...
onBeforeSave(updatedRow: any, originalRow: any) {
  ...
  return true;
}`),t()()()()()())},dependencies:[f],encapsulation:2})}return n})();var I=(()=>{class n{route;router;sub;hidePoWebSample=!0;samplesLength=1;activeTab="doc";actions=[{label:"Documenta\xE7\xE3o",action:this.goBack.bind(this),icon:"an an-file-text"},{label:"Colabore",action:this.improveDocs.bind(this)}];constructor(a,o){this.route=a,this.router=o}goBack(){this.router.navigate(["documentation"])}improveDocs(){this.router.navigate(["guides/development-flow"])}ngOnInit(){this.sub=this.route.queryParams.subscribe(a=>{let o=a.view;this.activeTab=o||"doc",this.hidePoWebSample=this.samplesLength===0})}ngOnDestroy(){this.sub.unsubscribe()}static \u0275fac=function(o){return new(o||n)(h(C),h(A))};static \u0275cmp=d({type:n,selectors:[["ng-component"]],standalone:!1,decls:6,vars:4,consts:[["p-title"," Grid",3,"p-actions"],["p-size","1"],["p-label","Documenta\xE7\xE3o",3,"p-active"],["p-label","Exemplos",3,"p-hide","p-active"]],template:function(o,l){o&1&&(e(0,"po-page-default",0)(1,"po-tabs",1)(2,"po-tab",2),r(3,"sample-po-grid-doc"),t(),e(4,"po-tab",3),r(5,"sample-po-grid-basic-view"),t()()()),o&2&&(m("p-actions",l.actions),s(2),m("p-active",l.activeTab.includes("doc")),s(2),m("p-hide",l.hidePoWebSample)("p-active",l.activeTab.includes("web")))},dependencies:[P,E,v,T,M],encapsulation:2})}return n})();var k=[{path:"",component:I}],F=(()=>{class n{static \u0275fac=function(o){return new(o||n)};static \u0275mod=u({type:n});static \u0275inj=c({imports:[b.forChild(k),b]})}return n})();var oe=(()=>{class n{static \u0275fac=function(o){return new(o||n)};static \u0275mod=u({type:n});static \u0275inj=c({imports:[B,F]})}return n})();export{oe as DocPoGridModule};
