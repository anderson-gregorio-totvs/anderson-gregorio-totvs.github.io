...
`),t()()())},dependencies:[C],encapsulation:2})}return i})();var M=(()=>{class i{route;router;sub;hidePoWebSample=!0;samplesLength=0;activeTab="doc";actions=[{label:"Documenta\xE7\xE3o",action:this.goBack.bind(this),icon:"an an-file-text"},{label:"Colabore",action:this.improveDocs.bind(this)}];constructor(a,n){this.route=a,this.router=n}goBack(){this.router.navigate(["documentation"])}improveDocs(){this.router.navigate(["guides/development-flow"])}ngOnInit(){this.sub=this.route.queryParams.subscribe(a=>{let n=a.view;this.activeTab=n||"doc",this.hidePoWebSample=this.samplesLength===0})}ngOnDestroy(){this.sub.unsubscribe()}static \u0275fac=function(n){return new(n||i)(c(E),c(S))};static \u0275cmp=p({type:i,selectors:[["ng-component"]],standalone:!1,decls:5,vars:4,consts:[["p-title"," Slide Content Template",3,"p-actions"],["p-size","1"],["p-label","Documenta\xE7\xE3o",3,"p-active"],["p-label","Exemplos",3,"p-hide","p-active"]],template:function(n,l){n&1&&(o(0,"po-page-default",0)(1,"po-tabs",1)(2,"po-tab",2),u(3,"sample-po-slide-content-template-doc"),t(),u(4,"po-tab",3),t()()),n&2&&(d("p-actions",l.actions),s(2),d("p-active",l.activeTab.includes("doc")),s(2),d("p-hide",l.hidePoWebSample)("p-active",l.activeTab.includes("web")))},dependencies:[g,b,x,D],encapsulation:2})}return i})();var w=[{path:"",component:M}],P=(()=>{class i{static \u0275fac=function(n){return new(n||i)};static \u0275mod=r({type:i});static \u0275inj=m({imports:[f.forChild(w),f]})}return i})();var L=(()=>{class i{static \u0275fac=function(n){return new(n||i)};static \u0275mod=r({type:i});static \u0275inj=m({imports:[h,P]})}return i})();export{L as DocPoSlideContentTemplateModule};
