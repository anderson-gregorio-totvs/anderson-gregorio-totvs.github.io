...
dinamicamente modificada dentro das regras de media query.`),t()()()(),o(60,"br"),i(61,"h3"),e(62,"Interfaces"),t(),i(63,"h4",19)(64,"code",5),e(65,"PoMediaQueryTokens"),t()(),i(66,"div",2)(67,"p"),e(68,`Interface que define os tokens CSS utilizados em regras de media queries.
...
};`),t()()()(),i(125,"tr",8)(126,"td",16)(127,"div",10)(128,"span",11),e(129," md"),o(130,"br"),t()()(),i(131,"td",17)(132,"code",22),e(133,`{ 'gridSystemMdMinWidth': string; 'gridSystemMdMaxWidth': string;
...
};`),t()()()(),i(159,"tr",8)(160,"td",16)(161,"div",10)(162,"span",11),e(163," offset"),o(164,"br"),t()()(),i(165,"td",17)(166,"code",23),e(167,`{ 'gridSystemOffsetMinWidth': string; 'gridSystemOffsetMaxWidth': string;
...
};`),t()()()(),i(193,"tr",8)(194,"td",16)(195,"div",10)(196,"span",11),e(197," pull"),o(198,"br"),t()()(),i(199,"td",17)(200,"code",24),e(201,`{ 'gridSystemPullMaxWidth': string;
...
};`),t()()()(),i(220,"tr",8)(221,"td",16)(222,"div",10)(223,"span",11),e(224," sm"),o(225,"br"),t()()(),i(226,"td",17)(227,"code",25),e(228,`{ 'gridSystemSmMaxWidth': string;
...
};`),t()()()(),i(247,"tr",8)(248,"td",16)(249,"div",10)(250,"span",11),e(251," xl"),o(252,"br"),t()()(),i(253,"td",17)(254,"code",26),e(255,`{ 'gridSystemXlMinWidth': string;
...
};`),t()()()()()())},encapsulation:2})}return n})();var b=(()=>{class n{route;router;sub;hidePoWebSample=!0;samplesLength=0;activeTab="doc";actions=[{label:"Documenta\xE7\xE3o",action:this.goBack.bind(this),icon:"ph ph-file-text"},{label:"Colabore",action:this.improveDocs.bind(this)}];constructor(d,a){this.route=d,this.router=a}goBack(){this.router.navigate(["documentation"])}improveDocs(){this.router.navigate(["guides/development-flow"])}ngOnInit(){this.sub=this.route.queryParams.subscribe(d=>{let a=d.view;this.activeTab=a||"doc",this.hidePoWebSample=this.samplesLength===0})}ngOnDestroy(){this.sub.unsubscribe()}static \u0275fac=function(a){return new(a||n)(u(E),u(g))};static \u0275cmp=s({type:n,selectors:[["ng-component"]],standalone:!1,decls:5,vars:4,consts:[["p-title"," Media Query",3,"p-actions"],["p-size","1"],["p-label","Documenta\xE7\xE3o",3,"p-active"],["p-label","Exemplos",3,"p-hide","p-active"]],template:function(a,r){a&1&&(i(0,"po-page-default",0)(1,"po-tabs",1)(2,"po-tab",2),o(3,"sample-po-media-query-doc"),t(),o(4,"po-tab",3),t()()),a&2&&(p("p-actions",r.actions),c(2),p("p-active",r.activeTab.includes("doc")),c(2),p("p-hide",r.hidePoWebSample)("p-active",r.activeTab.includes("web")))},dependencies:[y,f,h,v],encapsulation:2})}return n})();var D=[{path:"",component:b}],W=(()=>{class n{static \u0275fac=function(a){return new(a||n)};static \u0275mod=l({type:n});static \u0275inj=m({imports:[x.forChild(D),x]})}return n})();var F=(()=>{class n{static \u0275fac=function(a){return new(a||n)};static \u0275mod=l({type:n});static \u0275inj=m({imports:[M,W]})}return n})();export{F as DocPoMediaQueryModule};
