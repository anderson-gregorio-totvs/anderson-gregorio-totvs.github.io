...
Executada ao disparar o output `),n(952,"code"),e(953,"change"),t(),e(954," ou "),n(955,"code"),e(956,"change-model"),t(),e(957,", dependendo do valor da propriedade "),n(958,"code"),e(959,"triggerMode"),t(),e(960,"."),t()()(),n(961,"tr",16)(962,"td",17)(963,"div",18)(964,"span",19),e(965," triggerMode"),o(966,"br"),t()()(),n(967,"td",20)(968,"code",36),e(969,"'change' "),t(),n(970,"code",37),e(971," 'changeModel'"),t()(),n(972,"td",23)(973,"em")(974,"strong"),e(975,"(opcional)"),t()(),n(976,"p"),e(977,"Controla se o m\xE9todo ser\xE1 executado no disparo do output "),n(978,"code"),e(979,"change"),t(),e(980," ou "),n(981,"code"),e(982,"change-model"),t(),e(983,"."),t()()()()())},dependencies:[y],encapsulation:2})}return a})();var de=(()=>{class a{route;router;sub;hidePoWebSample=!0;samplesLength=3;activeTab="doc";actions=[{label:"Documenta\xE7\xE3o",action:this.goBack.bind(this),icon:"an an-file-text"},{label:"Colabore",action:this.improveDocs.bind(this)}];constructor(p,l){this.route=p,this.router=l}goBack(){this.router.navigate(["documentation"])}improveDocs(){this.router.navigate(["guides/development-flow"])}ngOnInit(){this.sub=this.route.queryParams.subscribe(p=>{let l=p.view;this.activeTab=l||"doc",this.hidePoWebSample=this.samplesLength===0})}ngOnDestroy(){this.sub.unsubscribe()}static \u0275fac=function(l){return new(l||a)(T(G),T(U))};static \u0275cmp=u({type:a,selectors:[["ng-component"]],standalone:!1,decls:8,vars:4,consts:[["p-title"," Login",3,"p-actions"],["p-size","1"],["p-label","Documenta\xE7\xE3o",3,"p-active"],["p-label","Exemplos",3,"p-hide","p-active"]],template:function(l,i){l&1&&(n(0,"po-page-default",0)(1,"po-tabs",1)(2,"po-tab",2),o(3,"sample-po-login-doc"),t(),n(4,"po-tab",3),o(5,"sample-po-login-basic-view")(6,"sample-po-login-labs-view")(7,"sample-po-login-confirm-view"),t()()()),l&2&&(c("p-actions",i.actions),m(2),c("p-active",i.activeTab.includes("doc")),m(2),c("p-hide",i.hidePoWebSample)("p-active",i.activeTab.includes("web")))},dependencies:[ee,v,C,oe,le,me,pe],encapsulation:2})}return a})();var ye=[{path:"",component:de}],se=(()=>{class a{static \u0275fac=function(l){return new(l||a)};static \u0275mod=D({type:a});static \u0275inj=k({imports:[A.forChild(ye),A]})}return a})();var Ze=(()=>{class a{static \u0275fac=function(l){return new(l||a)};static \u0275mod=D({type:a});static \u0275inj=k({imports:[te,se]})}return a})();export{Ze as DocPoLoginModule};
