...
</po-stepper>`),o()(),t(184,"p"),e(185,"Outra op\xE7\xE3o seria a customiza\xE7\xE3o do \xEDcone atrav\xE9s do "),t(186,"code"),e(187,"TemplateRef"),o(),e(188,", conforme exemplo abaixo:"),o(),t(189,"pre")(190,"code"),e(191,`<po-stepper>
   ...
...
</ng-template`),o()(),t(192,"blockquote")(193,"p"),e(194,"Deve-se usar "),t(195,"code"),e(196,"font-size: inherit"),o(),e(197," para ajustar \xEDcones que n\xE3o se ajustam automaticamente."),o()()()(),t(198,"tr",14)(199,"td",15)(200,"div",16)(201,"span",17),e(202," p-label"),r(203,"br"),o()()(),t(204,"td",18)(205,"code",23),e(206,"string"),o()(),t(207,"td",21),e(208,"-"),o(),t(209,"td",22)(210,"p"),e(211,"T\xEDtulo que ser\xE1 exibido descrevendo o passo ("),t(212,"em"),e(213,"step"),o(),e(214,")."),o()()()()())},dependencies:[g],encapsulation:2})}return i})();var y=(()=>{class i{route;router;sub;hidePoWebSample=!0;samplesLength=0;activeTab="doc";actions=[{label:"Documenta\xE7\xE3o",action:this.goBack.bind(this),icon:"an an-file-text"},{label:"Colabore",action:this.improveDocs.bind(this)}];constructor(a,n){this.route=a,this.router=n}goBack(){this.router.navigate(["documentation"])}improveDocs(){this.router.navigate(["guides/development-flow"])}ngOnInit(){this.sub=this.route.queryParams.subscribe(a=>{let n=a.view;this.activeTab=n||"doc",this.hidePoWebSample=this.samplesLength===0})}ngOnDestroy(){this.sub.unsubscribe()}static \u0275fac=function(n){return new(n||i)(u(S),u(f))};static \u0275cmp=l({type:i,selectors:[["ng-component"]],standalone:!1,decls:5,vars:4,consts:[["p-title"," Step",3,"p-actions"],["p-size","1"],["p-label","Documenta\xE7\xE3o",3,"p-active"],["p-label","Exemplos",3,"p-hide","p-active"]],template:function(n,p){n&1&&(t(0,"po-page-default",0)(1,"po-tabs",1)(2,"po-tab",2),r(3,"sample-po-step-doc"),o(),r(4,"po-tab",3),o()()),n&2&&(s("p-actions",p.actions),c(2),s("p-active",p.activeTab.includes("doc")),c(2),s("p-hide",p.hidePoWebSample)("p-active",p.activeTab.includes("web")))},dependencies:[b,v,h,P],encapsulation:2})}return i})();var F=[{path:"",component:y}],C=(()=>{class i{static \u0275fac=function(n){return new(n||i)};static \u0275mod=d({type:i});static \u0275inj=m({imports:[E.forChild(F),E]})}return i})();var H=(()=>{class i{static \u0275fac=function(n){return new(n||i)};static \u0275mod=d({type:i});static \u0275inj=m({imports:[D,C]})}return i})();export{H as DocPoStepModule};
